...
VoronoiDrip.FluidNetworkSimulation.Metrics = VoronoiDrip.FluidNetworkSimulation.Metrics || {};

VoronoiDrip.FluidNetworkSimulation.Metrics.create = function(spec) {
    var that = {};
    ...
    that.getFluidAtVertex = function(pipe, vertex) {
        ...
        while (fluidCount--) {
            ...
            if (
                ...
                && fluid.position <= VoronoiDrip.FluidNetworkSimulation.MINIMUM_FLUID_VOLUME
            ) {
                return fluid;
            }
            ...
            if (
                ...
                && fluid.volume + fluid.position >= pipe.capacity - VoronoiDrip.FluidNetworkSimulation.MINIMUM_FLUID_VOLUME
            ) {
                return fluid;
            }
        }
